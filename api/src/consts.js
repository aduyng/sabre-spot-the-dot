...
const RESEMBLE_IGNORE_NOTHING = "nothing";
const RESEMBLE_IGNORE_LESS = "less";
const RESEMBLE_IGNORE_COLORS = "colors";
const RESEMBLE_IGNORE_ALPHA = "alpha";
const RESEMBLE_IGNORE_ANTIALIASING = "antialiasing";

const RESEMBLE_IGNORE_METHODS = [
  RESEMBLE_IGNORE_ALPHA,
  RESEMBLE_IGNORE_COLORS,
  RESEMBLE_IGNORE_LESS,
  RESEMBLE_IGNORE_NOTHING,
  RESEMBLE_IGNORE_ANTIALIASING
];

const RESEMBLE_ERROR_MOVEMENT = "movement";
const RESEMBLE_ERROR_FLAT = "flat";
const RESEMBLE_ERROR_FLATDIFFINTENSE = "flatDifferenceIntensity";
const RESEMBLE_ERROR_MVTDIFFINTENSE = "movementDifferenceIntensity";
const RESEMBLE_ERROR_DIFFONLY = "diffOnly";

const RESEMBLE_ERROR_METHODS = [
  RESEMBLE_ERROR_DIFFONLY,
  RESEMBLE_ERROR_FLAT,
  RESEMBLE_ERROR_FLATDIFFINTENSE,
  RESEMBLE_ERROR_MVTDIFFINTENSE,
  RESEMBLE_ERROR_MOVEMENT
];
